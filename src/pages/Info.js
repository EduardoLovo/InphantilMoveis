    ...
    <div className="contentInfo fs-5">
      ...
      <div className="d-flex justify-content-center align-items-center infochild ">
        ...
        <div className="">
          <p>
            ...
            180 dias no revestimento. Esta garantia é fornecida pelas indústrias
            das matérias primas.
          </p>
          <p>
            Em caso de defeito de fabricação ou problemas advindos do transporte
      ...
      <div className="d-flex justify-content-center align-items-center infochild">
        <div className="">
          ...
          <p>
            ...
            e depois retire o sabão com um pano molhado, repita por algumas
            vezes até retirar todo sabão. Essa limpeza deve ser feita semanal ou
            quinzenalmente. No dia a dia utilize apenas um pano úmido com água.
          </p>
          <p>
            ⚠️ NÃO UTILIZAR: Veja, detergente líquido, álcool ou demais produtos
            químicos, pois são agressivos aos materiais utilizados e à saúde de
            seu filho!
          </p>
          <p>
            🚫 📣 Recomendamos retirar o colchão e colocá-lo em local arejado
            semanal ou quinzenalmente para evitar que haja proliferação de Mofo
            e Ácaro. Caso o produto fique em local de alta umidade realizar esse
            procedimento semanalmente. Utilizar um protetor impermeável auxilia
            a manter a integridade do colchão, pois evita que absorva líquidos
            que porventura venha a cair sobre o colchão. Em cidades muito úmidas
      ...
      <div className="d-flex justify-content-center align-items-center infochild">
        <div className="">
          ...
          <p>
            O mais indicado para instalação do seu protetor é ser feito em 2
            pessoas, para que o mesmo fique o mais esticado possível no momento
            da colagem. A colagem deve ser realizada em etapas, onde o velcro
            deve ser colado na sequência, inferior, superior, laterais. Caso sua
            casa tenha rodapé a instalação deve ser feita logo acima do mesmo.
          </p>
          <p>Passo a Passo da instalação:</p>
          <p>
            1. Estique o protetor de parede no local que deseja instalá-lo com o
            zíper voltado para baixo, em direção ao chão.
          </p>
          <p>
            2. Retire o papel do velcro autoadesivo da parte inferior por partes
            e vá colando na parede com muito cuidado, pois após colado
            dificilmente conseguirá retirar sem estragar a parede.
          </p>
          <p>
            3. Verifique se o protetor ficou colado bem esticado e logo acima do
            rodapé de forma reta antes de continuar a instalação.
          </p>
          <p>
            4. Retire o papel do velcro superior, também por partes, esticar bem
            o protetor antes de colar para que não fique frouxo e forme uma
            “barriga”.
          </p>
          <p>
            5. Após colar os velcros inferior e superior retire a fita do velcro
            lateral de um dos lados e depois do outro e PRONTO! Sua instalação
            está finalizada.
          </p>
          <p>
            Tome cuidado no momento de colar, pois o velcro é de alta fixação e
            após colado em sua parede a remoção é muito difícil e deve ser feita
            com muito cuidado,pois há grandes chances de arrancar a tinta,
