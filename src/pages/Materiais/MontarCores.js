...
export const MontarCores = () => {
    ...
    function compare(a, b) {
      ...
      const EscolhaExterno = (e) => {
        ...
        setExterno(<img className='resultMontagem' src={imagemUm} alt='imagemExterno'/>)
        setClick('escolhaUm')
      }
      ...
      const EscolhaInterno = (e) => {
        ...
        setInterno(<img className='resultMontagem' src={imagemDois} alt='imagemInterno'/>)
  ...
  return (
    <div>
        ...
        <div>
            ...
            <div>
                <button onClick={reset} className='m-2 p-1 btnCinza'>Escolher Novamente</button>
            </div>
        </div>
        :
        ''}
            ...
            <div className="coresLista">
                {materiais.map((material, index) => (
                    <div key={index} className={material.cor === 'Externo' ? 'cardMaterial' : 'display'}>
                        <div>
                            <img src={material.img}  alt='imagem do material' onClick={EscolhaExterno}/>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="coresLista">
                {materiais.map((material, index) => (
                    <div key={index} className={material.cor === 'Externo' ? 'display' : 'cardMaterial'}>
                        <div>
                            <img src={material.img}  alt='imagem do material' onClick={EscolhaInterno}/>
                        </div>
                    </div>
                ))}
            </div> 
